...
pygame.display.set_caption("Adventure Experience", 'AdventExp')
...
intro_text = ['', '                                                     ВТОРОЙ УРОВЕНЬ - ПУТЕШЕСТВИЕ В АД', '', '',
              ...
              '                                                                     Два типа врагов:',
              "                         1 - Летучие Мыши, высасывающие вашу кровь",
...
start_screen(intro_text, 'ThirdLevelFon.png', '#faf0e6', 24)
...
start_screen(record, 'RecordsFon.png', '#ffb300', 65)
